...
module.exports = class Room {
    ...
    addPlayer(player) {
        if (this.player_one === undefined) {
            ...
            this.game.currentTurn = this.player_one.name;
            return true;
    ...
    isNameTaken(name) {
        return (this.player_one && this.player_one.name === name) || (this.player_two && this.player_two.name === name);
    }

    isFull() {
        return this.player_one !== undefined && this.player_two !== undefined;
    }
