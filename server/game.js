...
const MAX_CUE_BALL_VEL = 5;

const COLOR_BLUE = '#3465a4';
const COLOR_BLACK = '#222222';
const COLOR_YELLOW = '#fce94f';
const COLOR_GREEN = '#8ae234';
const COLOR_RED = '#ef2929';
const COLOR_MAROON = '#a40000';
const COLOR_ORANGE = '#f57900';
const COLOR_PURPLE = '#5c3566';
